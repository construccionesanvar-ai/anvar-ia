/* GENERADO por scripts/build.mjs desde src/calculo.mjs. No editar: edita src/calculo.mjs. */
window.ANVAR_CALCULO = (function () {
  ...
  const porcentaje = (x) => (x === null || !Number.isFinite(x) ? 'No aplica' : miles(x * 100) + '%');
   ...
   */
  function ufAPesos(cantidad, valorUf) {
  ...
  function textoPayback(r, mesesMax = 36) {
  ...
  function lecturaRoi(r, mesesMax = 36) {
   ...
   */
  function resumenRoi(r, mesesMax = 36) {
   ...
   */
  function puntoPedido({ demanda, desvDemanda, plazo, desvPlazo, servicio }) {
  ...
  return { roi, MONTO_MAXIMO, leerPesos, miles, pesos, porcentaje, ufAPesos, SIN_DATO, textoPayback, lecturaRoi, resumenRoi, NIVELES_SERVICIO, puntoPedido };
})();
